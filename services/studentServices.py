...
from src.repository.studentRepo import RepoStudent, StudentTextFileRepo, StudentBinaryFileRepo, StudentJsonFileRepo
...
class StudentServices:
    def __init__(self, repo_type, file_name):
        if repo_type == "inmemory":
            ...
            self.repoStud = StudentTextFileRepo(file_name)
        elif repo_type == "binaryfiles":
            self.repoStud = StudentBinaryFileRepo(file_name)
        else:
            self.repoStud = StudentJsonFileRepo(file_name)
